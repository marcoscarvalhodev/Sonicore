...
export default class LegendaryGuitars {
  ...
  setLegendaryGuitars() {
    const LegendaryGuitars = `
      ...
      <h1 id="legendary-text-2" class="text-[3.2rem] absolute translate-x-[-100%] left-0 pl-[80px] mt-[8rem]">Airline Res-O-Glass "JB Hutto"</h1>
      
      <h1 id="legendary-text-1" class="text-[3.2rem] absolute translate-x-[100%] right-0 bottom-0 pr-[8rem] sm:mb-[15rem] md:mb-[8rem]">Gibson ES-335</h1>
